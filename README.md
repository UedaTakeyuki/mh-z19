...
- 2.3.9  2019.05.06  Revise the serial port selection logic. Support using **PL011** uart on **Raspberry Pi 3 and Raspberry Pi Zero W** which is selected by setting **dtoverlay=pi3-miniuart-bt** or **dtoverlay=pi3-disable-bt** Merge [Pull Request #10](https://github.com/UedaTakeyuki/mh-z19/pull/10). Thanks **片岡さん** for your kindly [report](https://qiita.com/yukataoka/items/a3b4065e8210b8f372ff#comment-ff1a3e2f31657988710e) including this issue!
